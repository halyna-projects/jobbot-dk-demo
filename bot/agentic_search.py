...
_SYSTEM_INSTRUCTION = (
    ...
    "Skriv altid én kort sætning på dansk om hvorfor du prøver netop dette ord, i SAMME svar som "
    "du kalder værktøjet -- aldrig kun sætningen alene. Hvis din sætning konkluderer, at "
    "'{keyword}' er en stavefejl af eller synonym med et rigtigt ord, SKAL du kalde værktøjet med "
    "det ord i det samme svar; det er en fejl at skrive konklusionen og så ikke handle på den. "
